#include <polynomial_regression.hh>
#include <iostream>
#include <algorithm>
#include <stdexcept>
#include <sstream>
 ...
 **/
PolynomialRegression::PolynomialRegression(const vector<double>& xs, const vector<double>& ys, int in_dims, int in_order) : dims(in_dims), order(in_order) {
...
/*
PolynomialRegression::PolynomialRegression(const vector<double>& in_powers, const vector<double>& in_coefficients, double in_dims, double in_order) : dims(in_dims), order(in_order) {
...
PolynomialRegression::PolynomialRegression(const vector<double>& in_coefficients, double in_dims, double in_order) : dims(in_dims), order(in_order) {
    numBasis = getNumBasis(dims, order);
    getBasisPowers(dims, order, powers);
    copy(in_coefficients.begin(), in_coefficients.end(), back_inserter(coefficients));
...
PolynomialRegression::PolynomialRegression(const PolynomialRegression& rhs) : dims(rhs.dims), order(rhs.order), numBasis(rhs.numBasis) {
...
int PolynomialRegression::getNumBasis(int in_dims, int in_order) {
...
//This is rather a silly algorithm, but it works and only happens rarely
void PolynomialRegression::getBasisPowers(int in_dims, int in_order, vector<double>& out_powers) {
    ...
    switch(in_dims) {
        ...
        default:
            throw new invalid_argument("PolynomialRegression::getBasisPowers: Invalid dimension only 1, 2, or 3 are valid values");
    }
...
void PolynomialRegression::basisEvals(const vector<double>& xs, vector<double>& outVals) {
...
double PolynomialRegression::eval(const vector<double>& xs) {

    if(xs.size() != dims) {
        throw new invalid_argument("PolynomialRegression::eval: xs must be the same length as polynomial dimensions.");
    }
    double retVal = 0;
...
void PolynomialRegression::basisGradients(const vector<double>& xs, vector<double>& outGrads) {
...
void PolynomialRegression::gradAllDims(const vector<double>& xs, vector<double>& outGrads) {
 ...
 */
double PolynomialRegression::grad1(const vector<double>& xs) {
 ...
 */
double PolynomialRegression::grad2(const vector<double>& xs) {
    vector<double> outGrads;
    gradAllDims(xs, outGrads);
 ...
 */
double PolynomialRegression::grad3(const vector<double>& xs) {
    vector<double> outGrads;
    gradAllDims(xs, outGrads);
...
/** Returns a string giving all the coefficients and their basis functions.
  ...
  **/
string PolynomialRegression::termsToString() {
...
void PolynomialRegression::dx(vector<double>& new_coefficients, vector<double>& new_powers){
...
void PolynomialRegression::dy(vector<double>& new_coefficients, vector<double>& new_powers){
    int ndims = new_powers.size()/new_coefficients.size();
    for (int b=0;b<numBasis;b++) {
...
void PolynomialRegression::dz(vector<double>& new_coefficients, vector<double>& new_powers){
    for (int b=0;b<numBasis;b++) {
...
double PolynomialRegression::evaluate(vector<double>& new_coefficients, vector<double>& new_powers, const vector<double>& xs){
    int N = xs.size();
    int total = 0;
    int mult;
...
double PolynomialRegression::derivX(const vector<double>& xs) {
...
double PolynomialRegression::derivY(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
...
double PolynomialRegression::derivZ(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
...
double PolynomialRegression::derivXX(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
...
double PolynomialRegression::derivYY(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
...
double PolynomialRegression::derivXY(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
...
double PolynomialRegression::derivYX(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
...
double PolynomialRegression::derivZZ(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
...
double PolynomialRegression::derivXZ(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
...
double PolynomialRegression::derivYZ(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
...
double PolynomialRegression::derivZX(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
...
double PolynomialRegression::derivZY(const vector<double>& xs) {
    vector<double> new_coefficients;
    vector<double> new_powers;
    int value;
